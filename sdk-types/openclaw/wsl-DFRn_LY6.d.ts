import { u as RetryOptions } from "./globals-BkKO3lYj.js";
...
declare function isWSL(environment?: {
  env?: NodeJS.ProcessEnv;
  platform?: NodeJS.Platform;
}): Promise<boolean>;
//#endregion
export { normalizeZaiEnv as C, normalizeEnv as S, retryAsync as T, formatDurationPrecise as _, resetWSLStateForTests as a, isTruthyEnvValue as b, ensureGlobalUndiciEnvProxyDispatcher as c, globalUndiciStreamTimeoutMs as d, resetGlobalUndiciStreamTimeoutsForTests as f, formatDurationHuman as g, formatDurationCompact as h, isWSLSync as i, ensureGlobalUndiciStreamTimeouts as l, FormatDurationSecondsOptions as m, isWSL2Sync as n, DEFAULT_UNDICI_STREAM_TIMEOUT_MS as o, FormatDurationCompactOptions as p, isWSLEnv as r, ensureGlobalUndiciDispatcherStreamTimeouts as s, isWSL as t, forceResetGlobalDispatcher as u, formatDurationSeconds as v, resolveEnvNormalizationKeys as w, logAcceptedEnvOption as x, expandEnvNormalizationKeys as y };