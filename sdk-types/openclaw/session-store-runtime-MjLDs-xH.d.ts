...
import { W as ResolvedSessionMaintenanceConfigInput, j as SessionEntry, w as AmbientTranscriptWatermark } from "./templating-BzAleqvS.js";
...
declare function getConversationSession(params: {
  agentId: string;
  env?: NodeJS.ProcessEnv;
  storePath?: string;
  channel: string;
...
//#endregion
export { resolveAmbientTranscriptWatermarkKey as A, isValidAgentHarnessSessionStoreEntry as C, parseSqliteSessionFileMarker as D, formatSqliteSessionFileMarker as E, sqliteSessionFileMarkerMatchesSession as O, upsertSessionEntry as S, SqliteSessionFileMarker as T, resolveSessionStoreEntry as _, deleteSessionEntry as a, updateSessionStore as b, listSessionEntries as c, patchSessionEntry as d, readAmbientTranscriptWatermark as f, resolveSessionStoreBackupPaths as g, resolveSessionFilePath as h, cleanupSessionLifecycleArtifacts as i, updateAmbientTranscriptWatermark as j, AmbientTranscriptWatermarkScope as k, loadSessionStore as l, readTranscriptStatsSync as m, SessionStoreTranscriptEvent as n, getConversationSession as o, readSessionUpdatedAt as p, UpdateSessionStoreOptions as r, getSessionEntry as s, LoadSessionStoreOptions as t, loadTranscriptEventsSync as u, resolveStorePath as v, clearSessionStoreCacheForTest as w, updateSessionStoreEntry as x, resolveTranscriptSessionKeyBySessionId as y };